...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Secure, auditable e-signatures for modern businesses in India. Every signature logged with timestamp, IP, and identity verification." },
      { name: "author", content: "eSignRight" },
      { property: "og:title", content: "eSignRight | Fast, Legal, and Secure E-Signatures for India" },
      { property: "og:description", content: "Secure, auditable e-signatures for modern businesses in India. Every signature logged with timestamp, IP, and identity verification." },
