...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700&family=Lato:wght@400&display=swap" },
    ],
  }),
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    ...
    posthog.init('phc_oU8G6omHaYj872gNpFa3A2sgbTp85sfkMj53mYaxo2QQ', {
